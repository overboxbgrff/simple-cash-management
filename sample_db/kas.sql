...
CREATE TABLE `kas_keluar` (
  ...
  `tanggal_kk` varchar(64) NOT NULL,
  `kode_kk` varchar(64) NOT NULL,
...
('KK-20241203-120423', '03/12/2024', 'B.A', 'aaa', 120000);
...
CREATE TABLE `kas_masuk` (
  ...
  `tanggal_km` varchar(64) NOT NULL,
  `kode_km` varchar(64) NOT NULL,
...
('KM-20241203-121913', '2024-12-03', 'S.A', 'Saldo Awal Bulan', 200000000),
