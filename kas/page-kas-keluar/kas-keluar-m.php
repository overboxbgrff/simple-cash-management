...
<head>
    ...
    <title>Cash Management - Kode Kas Keluar</title>
</head>
        ...
        <div class="container">
            <div class="card border-primary">
                ...
                <!--Header-->    
                    <div class="row">
                        <div class="col-lg-12">
                            <h1><i class="fa-solid fa-hand-holding-dollar"> </i> Manajemen Kode Kas Keluar</h1>
                        </div>
                    </div>
                            ...
                            <!-- Modal -->
                                <div class="modal fade" id="tambah-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="process.php?act=tambah-kk" method="POST">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="kode_kk" placeholder="Kode Kas Keluar...">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="desk_kk" class="form-label">Keterangan Kode Kas Keluar</label>
                                                            <textarea name="desk_kk" class="form-control" rows="2"></textarea>
                                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr class="table-dark">
                                            <th scope="col">Kode Kas Keluar</th>
                                    ...
                                    <tbody>
                                        <?php
                                            if (isset($_GET['cari'])){
                                                $cari = $_GET['cari'];
                                                $pagination = mysqli_query($conn,"SELECT * FROM jenis_kk WHERE kode_kk LIKE '%$cari%' OR desk_kk LIKE '%$cari%' 
                                                                            ORDER BY id_kk ASC LIMIT $start_pages,$data_pages");
                                            } else {
                                                $pagination = mysqli_query($conn,"select * from jenis_kk ORDER BY id_kk ASC LIMIT $start_pages,$data_pages");
                                            }
                                            while($td = mysqli_fetch_array($pagination)){ 
                                        ?>
                                        <tr>
                                            <td><?php echo $td['kode_kk'];?></td>
                                            <td><?php echo $td['desk_kk'];?></td>
                                            <!-- Button Hapus -->
                                                <td>   
                                                    <a href="#" class="btn btn-outline-danger text-center" data-bs-toggle="modal" data-bs-target="#hapus-kk<?php echo $td['id_kk'];?>"><i class="fa-solid fa-trash"></i> Hapus</a>
                                                    <div class="modal fade" id="hapus-kk<?php echo $td['id_kk'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                    <!-- Header -->
                                                                    <div class="modal-header">
                                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data? (<?php echo $td['kode_kk']."-".$td['desk_kk']; ?>)</h1>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <!-- Modal Body -->
                                                                    <div class="modal-body">
                                                                        <h3>Apakah anda ingin menghapus Kode ini?</h3>
                                                                        <h5><?php echo $td['kode_kk']."-".$td['desk_kk']; ?></h5>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark"> </i> Batal</button>
                                                                        <a href="process.php?act=hapus_kk&id=<?php echo $td['id_kk'];?>" class="btn btn-danger text-center"><i class="fa-solid fa-trash"></i> Hapus</a>
                                                                    </div>
                                                            </div>                                                            
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- Button Edit -->    
                                                <td>
                                                    <a href="#" class="btn btn-outline-info text-center" data-bs-toggle="modal" data-bs-target="#edit-kk<?php echo $td['id_kk'];?>"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                                    <div class="modal fade" id="edit-kk<?php echo $td['id_kk'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form action="process.php?act=edit-kk&id=<?php echo $td['id_kk'];?>" method="POST">
                                                                    <!-- Header -->
                                                                    <div class="modal-header">
                                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Kas Keluar (<?php echo $td['kode_kk']."-".$td['desk_kk']; ?>)</h1>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>

                                                                    <!-- Modal Body -->
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="e_id_kk" class="form-control" value="<?php echo $td['id_kk'];?>">
                                                                        <div class="mb-3">
                                                                            <label for="e_kode_kk" class="form-label">Kode Kas Keluar</label>
                                                                            <input type="text" class="form-control" name="e_kode_kk" placeholder="Kode Kas Keluar..." value="<?php echo $td['kode_kk'];?>">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="e_desk_kk" class="form-label">Keterangan Kode Kas Keluar</label>
                                                                            <textarea name="e_desk_kk" class="form-control" rows="2"><?php echo $td['desk_kk'];?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark"> </i> Batal</button>
